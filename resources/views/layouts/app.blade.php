...
<head>
    ...
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet"
        ...
        header {
            background-color: 	#00008B; /* Warna biru awan */
            color: white;
        }
...
<body>
    <header>
        <nav class="navbar navbar-expand-lg">
            <div class="container-fluid">
                <a class="navbar-brand" href="{{ route('admin.dashboard.index') }}">WARUNG MAKAN KAK JUMSARIDAH</a>
    ...
    <footer>
        Copyright &copy; 2024. Designed by Ayyina Nurhidayah
    </footer>
