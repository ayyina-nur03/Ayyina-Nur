                ...
                <div class="card-body">
                    <form action="{{ route('admin.customers.update', $p->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="no_pem" value="{{ $p->no_pem }}" id="no_pem" class="form-control" >
                            @error('no_pem')
                                <div class="alert alert-danger mt-2 mb-2 p-2">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" name="kode" value="{{ $p->kode }}" id="kode" class="form-control" >
                            @error('kode')
                                <div class="alert alert-danger mt-2 mb-2 p-2">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" name="nama_pem" value="{{ $p->nama_pem }}" id="nama_pem" class="form-control" >
                            @error('nama_pem')
                                <div class="alert alert-danger mt-2 mb-2 p-2">{{ $message }}</div>
                            @enderror
                        </div>
